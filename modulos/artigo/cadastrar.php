...
try {
	...
	$stArtigo = Conexao::chamar()->prepare("SELECT artigo.*
                                	          FROM artigo
                                	         WHERE artigo.id = :id
                                	           AND artigo.status_registro = :status_registro");
...
$tabelaAnexo = "artigo_anexo";
$relacionamentoTabelaAnexo = "artigo";
$tabelaVideo = "artigo_video";
$relacionamentoTabelaVideo = "artigo";
$tabelaFoto = "artigo_foto";
