...
$stMunicipio = Conexao::chamar()->prepare("SELECT *, municipio.nome as cidade, municipio.id as meuIdMunicipio
	  FROM municipio
	   JOIN estado ON municipio.id_estado = estado.id
	 WHERE municipio.status_registro = 'A'
...
$stArtigo = Conexao::chamar()->prepare("SELECT imovel.*, imovel.id meuID, municipio.nome cidade, estado.nome estado,  negocio.titulo negocio, tipo_imovel.titulo tipo_imovel
										FROM imovel
										LEFT JOIN municipio 
...
$stCidade = Conexao::chamar()->prepare("SELECT *, municipio.nome as cidade
	  FROM municipio
	   JOIN estado ON municipio.id_estado = estado.id
	 WHERE municipio.status_registro = 'A'
	   AND municipio.id = :id");
				...
				<div id="home" class="tab-pane fade in active">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<?php 
							if($buscaArtigo['lancamento'] == "S"){?>

							<option selected value="<?= $buscaArtigo['lancamento']?>"><?= $buscaArtigo['lancamento']?></option>
							<option value="N">N</option>

							<?php }elseif ($buscaArtigo['lancamento'] == "N") { ?>
								<option selected value="<?= $buscaArtigo['lancamento']?>"><?= $buscaArtigo['lancamento']?></option>
								<option value="S">S</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<?php 
							if($buscaArtigo['destaque'] == "S"){?>

							<option selected value="<?= $buscaArtigo['destaque']?>"><?= $buscaArtigo['destaque']?></option>
							<option value="N">N</option>

							<?php }elseif ($buscaArtigo['destaque'] == "N") { ?>
								<option selected value="<?= $buscaArtigo['destaque']?>"><?= $buscaArtigo['destaque']?></option>
								<option value="S">S</option>
...
<? 
if($buscaArtigo['edificio'] == "" || $buscaArtigo['edificio'] == NULL){
 ?>

					<div id="apartamento" class="form-group">
						<label class="col-sm-2 control-label">Adicionar Apartamento</label>
						<div class="col-sm-10">
							<button type="button" value="Click" class="btn btn-success">Novo apto</button>
						</div>
					</div>
<?
 } 
?>
					<div class="form-group" id="edificio" <?= $buscaArtigo['edificio'] != "" || $buscaArtigo['edificio'] != NULL  ? "" :  'style="display:none"'; ?>>
						<label for="edificio" class="col-sm-2 control-label">Edifício</label>
						<div class="col-sm-10">
							<input type="text" name="edificio" id="edificio" value="<?= $buscaArtigo['edificio'] ?>" class="form-control" placeholder="Informe o andar...">
						</div>
					</div>

					<div class="form-group" id="apto_andar" <?= $buscaArtigo['edificio'] != "" || $buscaArtigo['edificio'] != NULL  ? "" :  'style="display:none"'; ?>>
						<label for="apto_andar" class="col-sm-2 control-label">Andar Apto</label>
						<div class="col-sm-10">
							<input type="text" name="apto_andar" id="apto_andar" value="<?= $buscaArtigo['apto_andar'] ?>" class="form-control" placeholder="Informe o andar...">
						</div>
					</div>

					<div class="form-group" id="num_apto" <?= $buscaArtigo['edificio'] != "" || $buscaArtigo['edificio'] != NULL  ? "" : 'style="display:none"'; ?> >
						<label for="num_apto" class="col-sm-2 control-label">Numero Apto</label>
						<div class="col-sm-10">
							<input type="text" name="num_apto" id="num_apto" value="<?= $buscaArtigo['num_apto'] ?>" class="form-control" placeholder="Informe o Numero...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="valor" id="valor" class="form-control dinheiro" value="<?= $buscaArtigo['valor'] ?>"  placeholder="Informe o valor...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="number" name="num_suites" id="num_suites" value="<?= $buscaArtigo['num_suites'] ?>" class="form-control" placeholder="Informe o numero...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="number" name="num_quartos" id="num_quartos" value="<?= $buscaArtigo['num_quartos'] ?>" class="form-control" placeholder="Informe o t&iacute;tulo...">
						</div>
					</div>

					<div class="form-group">
						<label for="num_garagem" class="col-sm-2 control-label">Numero de Garagem</label>
						<div class="col-sm-10">
							<input type="number" name="num_garagem" id="num_garagem" value="<?= $buscaArtigo['num_garagem'] ?>" class="form-control" placeholder="Informe o t&iacute;tulo...">
						</div>
					</div>

					<? 
					$preencherComodos = $buscaArtigo['comodos'];
					if($buscaArtigo['meuID'] == "" || !isset($buscaArtigo['meuID'])){
						$preencherComodos = '<strong>1 Dormitório(s), sendo:</strong><br> Quarto; <br><br><strong>1 Ambiente(s), sendo:</strong><br> Sala e Cozinha conjugada; <br><br><strong>1 Serviço(s), sendo:</strong><br> Área de Serviço; <br><br><strong>1 BWC(s), sendo:</strong><br> BWC Social';
					} ?>

					<div class="form-group">
						<label for="comodos" class="col-sm-2 control-label">Cômodos</label>
						<div class="col-sm-10">
							<textarea name="comodos" id="comodos" class="form-control editor"><?= $preencherComodos ?></textarea>
						</div>
					</div>

					<div class="form-group">
						<label for="artigo" class="col-sm-2 control-label">Descrição</label>
						<div class="col-sm-10">
				...
				<div id="menu1" class="tab-pane fade">
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<option value="<?= $buscaArtigo['id_municipio']?>" selected><?= $buscaCidade['cidade']?> - <?= $buscaCidade['uf']?></option>
							...
							<?php } ?>
								...
								<?php foreach ($buscaMunicipio as $key => $municipio) { ?>
									<option name="id_municipio" value="<?= $municipio['meuIdMunicipio']?>" ><?= $municipio['cidade']?> - <?= $municipio['uf']?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="logradouro" id="logradouro" value="<?= $buscaArtigo['logradouro'] ?>" class="form-control" placeholder="Informe o t&iacute;tulo...">
						</div>
					</div>
					...
					<div class="form-group" id="bairro_novo" style="display: none">
						...
						<div class="col-sm-10">
							<input type="text" name="bairro" id="bairro" value="" class="form-control" placeholder="Informe o bairro...">
						</div>
					</div>
					...
					<div class="form-group" id="bairro_antigo">
						...
						<div class="col-sm-10">
							<select class="form-control" name="bairro" id="bairro" class="selectpicker" data-show-subtext="true" data-live-search="true">
							...
							<?php }else{?>
								...
								<option selected value="">Escolha um Bairro...</option>

							<?php } ?>
								<?php foreach ($buscaBairro as $key => $bairro) { 
										if($buscaArtigo['bairro'] != $bairro['bairro'] and $bairro['bairro'] != ''){?>
									<option value="<?= $bairro['bairro']?>" name="bairro"><?= $bairro['bairro']?></option>
								<?php 	}
									} ?>
							</select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="numero" id="numero" value="<?= $buscaArtigo['numero'] ?>" class="form-control" placeholder="Informe o numero...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="cep" id="cep" onkeypress="mascara(this, '#####-###')" value="<?= $buscaArtigo['cep'] ?>" class="form-control" placeholder="Informe o cep...">
					...
					<div class="form-group">
						<label for="area" class="col-sm-2 control-label">Area total</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="area_construida" class="col-sm-2 control-label">Area construida</label>
						<div class="col-sm-10">
							<input type="text" name="area_construida" id="area_construida" value="<?= $buscaArtigo['area_construida'] ?>" class="form-control" placeholder="Informe a area...">
						</div>
					</div>

					<div class="form-group">
						<label for="area_terreno" class="col-sm-2 control-label">Area terreno</label>
						<div class="col-sm-10">
							<input type="text" name="area_terreno" id="area_terreno" value="<?= $buscaArtigo['area_terreno'] ?>" class="form-control" placeholder="Informe a area...">
						</div>
					</div>

					<div class="form-group">
						<label for="area_edicula" class="col-sm-2 control-label">Area Edicula</label>
						<div class="col-sm-10">
							<input type="text" name="area_edicula" id="area_edicula" value="<?= $buscaArtigo['area_edicula'] ?>" class="form-control" placeholder="Informe a area...">
						</div>
					</div>
				...
				<div id="menu2" class="tab-pane fade">
					...
					<div class="" style="display: flex; flex-direction: column; justify-content: center; align-items: center; flex-wrap: wrap; border: 1px solid #DDD;">
...
$('#apartamento').click(function() {
	document.getElementById("apto_andar").style.display='block';
	document.getElementById("num_apto").style.display='block';
	document.getElementById("edificio").style.display='block';
	removeElement("apartamento");
})
