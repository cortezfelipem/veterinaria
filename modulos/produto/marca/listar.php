...
if($_REQUEST['id_excluir']) {
	...
	excluir($_REQUEST['id_excluir'], "produto_marca", "produto", "id_marca");
...
<form class="form-horizontal collapse" id="form-busca" action="<?= $caminhoTela ?>" method="POST">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" name="marca" id="marca" class="form-control" value="<?= $marca ?>" placeholder="Informe a descri&ccedil;&atilde;o...">
		</div>
	</div>
			...
			<tr>
				<td class="text-center">
					<?php if($buscaArtigo['status_registro'] == "A") { ?>
						...
						<?php } ?>
					<?php } else { ?>
						<a href="#" class="text-info btn-lista" onclick="restaurar('produto_marca', '<?= $buscaArtigo['id'] ?>', '<?= $caminhoTela ?>');" data-toggle="tooltip" data-placement="right" title="Restaurar Registro"><i class="fa fa-undo"></i></a>
					<?php } ?>
				</td>
